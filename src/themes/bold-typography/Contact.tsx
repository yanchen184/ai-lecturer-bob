    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-26 relative">
        ...
        <div className="mb-18 scroll-reveal">
          <div
            className="inline-flex items-center gap-2 mb-6 pb-2"
          ...
          <h2 id="contact-title" className="section-title text-left mb-4 text-white">
            聯繫我
          </h2>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 scroll-reveal stagger-1">
            ...
            <p className="text-sm mb-8 leading-relaxed" style={{ color: '#6B7280' }}>
              無論是企業培訓、個人課程諮詢，或是 AI 導入顧問服務，都歡迎透過以下方式與我聯繫。我會在 24 小時內回覆您的訊息。
            </p>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {info.action ? (
                      <button
                        onClick={info.action}
                        className="text-white hover:text-white transition-colors duration-200 text-sm font-bold flex items-center gap-2"
                      >
                        <span className="truncate">{info.value}</span>
                        <span
                          className="text-xs px-2 py-0.5 rounded-md transition-all duration-200 flex-shrink-0"
                          style={{
                            border: `1px solid ${emailCopied ? '#6366F1' : '#1F1F1F'}`,
                            color: emailCopied ? '#6366F1' : '#6B7280',
                          }}
                        >
                          {info.actionLabel}
                        </span>
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm mb-1.5 uppercase tracking-wider font-medium"
                      style={{ color: '#9CA3AF' }}
                    >
                      姓名 <span style={{ color: '#6366F1' }}>*</span>
                    </label>
                    <input
                      type="text"
                      id="name"
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label
                      ...
                      style={{ color: '#9CA3AF' }}
                    >
                      諮詢主題 <span style={{ color: '#6366F1' }}>*</span>
                    </label>
                    <select
                      id="subject"
                      required
                ...
                <div>
                  <label
                    ...
                    style={{ color: '#9CA3AF' }}
                  >
                    訊息內容 <span style={{ color: '#6366F1' }}>*</span>
                  </label>
                  <textarea
                    id="message"
                    required
                ...
                <button
                  ...
                  className="w-full py-4 font-bold text-lg rounded-xl text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  style={{
                    background: '#6366F1',
                ...
                {submitStatus === 'error' && (
                  ...
                  >
                    ...
                    <span className="text-sm" style={{ color: '#EF4444' }}>
                      發送失敗，請直接寄信至
                      <button onClick={copyEmail} className="underline ml-1 hover:text-white">

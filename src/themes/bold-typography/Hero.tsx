...
const Hero = () => {
  ...
  return (
    <section
      ...
      aria-label="首頁橫幅"
    >
      {/* Subtle gradient circle behind title */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(99,102,241,0.08) 0%, rgba(236,72,153,0.04) 50%, transparent 70%)' }} />

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div>
          {/* Badge */}
          <div className="scroll-reveal stagger-1 inline-flex items-center px-5 py-2.5 rounded-full mb-8" style={{ background: 'rgba(99,102,241,0.1)', border: '1px solid rgba(99,102,241,0.2)' }}>
            <span className="w-2 h-2 rounded-full animate-pulse mr-2" style={{ background: '#6366F1' }} />
            <span className="text-sm" style={{ color: '#9CA3AF' }}>目前開放企業培訓與程式教學諮詢</span>
          </div>

          <h1 className="scroll-reveal stagger-2 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight" style={{ letterSpacing: '-0.03em' }}>
          ...
          <p className="scroll-reveal stagger-4 mb-8 max-w-2xl mx-auto font-mono text-sm leading-relaxed" style={{ color: '#6B7280' }}>
          ...
          <div className="scroll-reveal stagger-5 mb-8 italic font-mono" style={{ color: '#6B7280' }}>
          ...
          <div className="scroll-reveal stagger-6 flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              style={{ border: '1px solid #1F1F1F', color: '#9CA3AF', background: 'transparent' }}
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            >
              <div className="text-3xl md:text-4xl font-extrabold gradient-text mb-2 font-mono" style={{ letterSpacing: '-0.02em' }}>{stat.number}</div>

...
const About = () => {
  ...
  useEffect(() => {
    ...
    const revealEls = section.querySelectorAll('.scroll-reveal, .scroll-reveal-left, .scroll-reveal-right');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative z-10">
              <div className="motion-card p-8 md:p-12">
                ...
                >
                  ...
                  >
                    <span className="text-5xl md:text-6xl font-extrabold gradient-text">彥</span>
                  </div>
                </div>

                <h3 className="text-2xl font-bold text-center text-white mb-2">陳彥彤</h3>
                <p className="text-center mb-4 font-mono text-sm" style={{ color: '#6366F1' }}>// 資深後端工程師 / 程式講師</p>
          ...
          <div className="scroll-reveal-right">
            <div className="font-mono text-sm mb-2" style={{ color: '#374151' }}>{'<section id="about">'}</div>
            <h2 id="about-title" className="section-title text-left">
              <span className="gradient-text">關於我</span>
            </h2>
            <p className="font-mono text-sm mb-6" style={{ color: '#6366F1' }}>// About Me - 程式講師陳彥彤</p>
            ...
            <div className="font-mono text-sm mt-4" style={{ color: '#374151' }}>{'</section>'}</div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              {[
                ...
                <div key={index} className={`scroll-reveal stagger-${index + 1} motion-card p-4`}>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            <div className="relative z-10">
              ...
              <div className="glass-card p-8 md:p-12" style={{ transform: 'rotate(-0.8deg)' }}>
                ...
                {/* Quick Info */}
                <div className="space-y-3" style={{ color: 'var(--pencil-grey)' }}>
          ...
          <div>
            ...
            <p className="text-lg mb-6 mono-label">About Me - 程式講師陳彥彤</p>

            <div className="space-y-6 leading-relaxed" style={{ color: 'var(--pencil-grey)' }}>
              <p>
                大家好，我是<strong style={{ color: 'var(--marker-black)' }}>陳彥彤</strong>，
                一位<strong className="marker-highlight">資深後端工程師</strong>兼<strong className="marker-highlight">程式講師</strong>。
                擁有 <strong style={{ color: 'var(--marker-black)' }}>5-6 年</strong>的 Java 後端開發經驗，
                專精於<strong style={{ color: 'var(--marker-black)' }}>企業級系統架構</strong>與<strong style={{ color: 'var(--marker-black)' }}>高併發解決方案</strong>。
              </p>

              <p>
                曾任職於電商核心系統團隊，主責
                <strong style={{ color: 'var(--marker-black)' }}>智能倉儲系統(WMS)</strong>、
                <strong style={{ color: 'var(--marker-black)' }}>訂單管理系統(MOX)</strong>、
                <strong style={{ color: 'var(--marker-black)' }}>貨品管理系統(MIX)</strong>的開發與維護。
                系統每日處理上萬筆 API 請求，平均延遲維持低於 200ms。
              </p>

              <p>
                在技術專長方面，我專精於
                <strong style={{ color: 'var(--marker-black)' }}>Spring Boot</strong>、
                <strong style={{ color: 'var(--marker-black)' }}>MySQL</strong>、
                <strong style={{ color: 'var(--marker-black)' }}>Redis</strong>、
                <strong style={{ color: 'var(--marker-black)' }}>RabbitMQ</strong> 等後端技術，
                同時具備 <strong style={{ color: 'var(--marker-black)' }}>React</strong> 前端開發能力，
                能夠進行完整的全端專案開發與教學。
              </p>

              <p>
                現在，我將這些年累積的<strong className="marker-highlight">實戰經驗</strong>
                轉化為系統化的教學內容，

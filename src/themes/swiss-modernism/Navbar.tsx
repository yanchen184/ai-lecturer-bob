...
const Navbar = () => {
  ...
  const handleHomeNavClick = (
    ...
    if (isHomePage) {
      ...
      // Navigate to home route (HashRouter), then scroll after render.
            ...
            <div className="hidden lg:flex items-center space-x-3">
              {homeNavItems.map((item) => (
                <a
                  ...
                  className={`relative px-3 py-3 text-sm font-bold transition-all duration-100 ${
                    isActive(item.href)
              ...
              <Link
                to="/blog"
                className={`px-3 py-3 text-sm font-bold transition-all duration-100 ${
              ...
              <a
                ...
                className="ml-12 px-5 py-3 text-sm font-black text-black transition-transform duration-100 hover:-translate-y-0.5"
                style={{
                  backgroundColor: '#FFEB3B',

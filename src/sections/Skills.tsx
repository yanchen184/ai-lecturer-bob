const Skills = () => {
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(180deg, rgba(15,21,33,0.5) 0%, rgba(10,14,23,1) 100%)' }}
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div
                  ...
                  style={{
                    ...
                    border: `1px solid ${category.colorHex}33`,
                ...
                {category.skills.map((skill, skillIndex) => (
                  <div key={skillIndex}>
                    <div className="flex justify-between mb-1">
                      <span className="text-gray-400 text-sm font-mono">{skill.name}</span>
                      <span className="text-neon-green text-sm font-mono">{skill.level}%</span>
                    </div>
        ...
        <div className="mt-12 glass-card p-8">
          <h3 className="text-xl font-bold text-white text-center mb-6 font-mono">
            <span className="text-neon-blue">{'<'}</span>前端開發技能<span className="text-neon-blue">{' />'}</span>
          </h3>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={index}>
                <div className="flex justify-between mb-1">
                  <span className="text-gray-400 text-sm font-mono">{skill.name}</span>
                  <span className="text-neon-purple text-sm font-mono">{skill.level}%</span>
                </div>
                <div className="skill-bar">
                  <div className="skill-bar-fill" style={{ width: `${skill.level}%` }} />
                </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <span
                key={index}
                className="px-4 py-2 text-gray-400 rounded-full text-sm font-mono hover:text-neon-green transition-all duration-300 cursor-default"

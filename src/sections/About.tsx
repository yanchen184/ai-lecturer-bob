      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            <div className="relative z-10">
              ...
              <div className="glass-card p-8 md:p-12">
                ...
                <p className="text-aurora-ice text-center mb-4">資深後端工程師 / 程式講師</p>
                ...
                <div className="space-y-3 text-gray-300">
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-aurora-ice" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <p className="text-aurora-ice text-lg mb-6">About Me - 程式講師陳彥彤</p>

            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p>
                大家好，我是<strong className="text-white">陳彥彤</strong>，
                一位<strong className="text-aurora-ice">資深後端工程師</strong>兼<strong className="text-aurora-purple">程式講師</strong>。
                擁有 <strong className="text-white">5-6 年</strong>的 Java 後端開發經驗，
                專精於<strong className="text-aurora-ice">企業級系統架構</strong>與<strong className="text-aurora-purple">高併發解決方案</strong>。
              </p>

              <p>
                曾任職於電商核心系統團隊，主責
                <strong className="text-aurora-ice">智能倉儲系統(WMS)</strong>、
                <strong className="text-aurora-purple">訂單管理系統(MOX)</strong>、
                <strong className="text-aurora-ice">貨品管理系統(MIX)</strong>的開發與維護。
                系統每日處理上萬筆 API 請求，平均延遲維持低於 200ms。
              </p>

              <p>
                在技術專長方面，我專精於
                <strong className="text-aurora-ice">Spring Boot</strong>、
                <strong className="text-aurora-purple">MySQL</strong>、
                <strong className="text-aurora-ice">Redis</strong>、
                <strong className="text-aurora-purple">RabbitMQ</strong> 等後端技術，
                同時具備 <strong className="text-white">React</strong> 前端開發能力，
                能夠進行完整的全端專案開發與教學。
              </p>

              <p>
                現在，我將這些年累積的<strong className="text-aurora-pink">實戰經驗</strong>
                轉化為系統化的教學內容，
